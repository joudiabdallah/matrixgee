...
//arma::vec y = as<arma::vec>(long_format_dataset["y"]);
        ...
        while (!converged && iteration < max_iter) {
                ...
                //  Refit with current fixed correlation and current beta_start
                ...
                //  Not converged: update state for next iteration
                estimate_a = new_beta;
                residuals  = new_resids;
                beta_start = estimate_a;

                //  Re-estimate the general correlation FROM updated residuals
                ...
                //  Refresh the fixed-correlation vector for the next fit
